(() => {
    ...
    function initSliders() {
        if (document.querySelector(".aromas__slider")) {
            const aromaSLider = new Swiper(".aromas__slider", {
                modules: [ Autoplay ],
                initialSlide: 2,
                observer: true,
                observeParents: true,
                ...
                on: {
                    click(event) {
                        aromaSLider.slideTo(this.clickedIndex);
                    }
                }
            });
        }
    ...
    function sortForTabs() {
        let worksButton = document.querySelectorAll(".collection__button");
        let worksItem = document.querySelectorAll(".collection__item");
        for (let i = 0; i < worksButton.length; i++) worksButton[i].addEventListener("click", (function() {
            for (let j = 0; j < worksButton.length; j++) worksButton[j].classList.remove("active");
